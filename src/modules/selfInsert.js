exportModule({
	id: "selfInsert",
	description: "add automail to the apps page",
	isDefault: true,
	categories: ["Script"],
	visible: false,
	...
	code: function(){
		let waiter = function(){
			...
			if(document.querySelector(".app.automail")){
				return
			}
			...
			if(
				...
				app.classList.add("automail");
				app.href = "https://greasyfork.org/en/scripts/370473-automail";
				...
				app.children[1].textContent = "Automail";
